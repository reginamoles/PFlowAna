...
class xAODPFlowAna : public EL::Algorithm
{
 ...
 private:
  ...
  void fillEffPurHistoMatch(int i_mcPart, xAOD::TruthParticleContainer::const_iterator tp_itr, const std::vector<double>& v_Efficiency, const std::vector<double>& v_Purity, bool twoClusters, const bool correctMatch);
