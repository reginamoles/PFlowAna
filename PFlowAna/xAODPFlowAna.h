...
class xAODPFlowAna : public EL::Algorithm
{
 ...
 private:
  ...
  //The index of the eflow charged object associated with the ith mc particle.
   ...
   std::vector<double> _mc_etaTrkEM1;    //!
   std::vector<double> _mc_phiTrkEM1;    //!
   std::vector<double> _mc_etaTrkEM2;    //!
   std::vector<double> _mc_phiTrkEM2;    //!
   std::vector<double> _mc_etaTrkEM3;    //!
   std::vector<double> _mc_phiTrkEM3;    //!
  ...
  int fillEffPurHistoDefault(int i_mcPart, const std::vector<double>& v_Efficiency, const std::vector<double>& v_Purity);
